...
* **[Github库](https://github.com/nzw9314/QuantumultX.git) WorkingCopy挂载我的库**

* **[挂载教程](https://m.youtube.com/watch?t=3s&v=inCQFnDmRLo) YouTube视频教程**
...
* 如果任何单位或个人认为该项目的脚本可能涉嫌侵犯其权利，则应及时通知并**提供身份证明，所有权证明**，我们将在收到认证文件后删除相关脚本.

* **nzw9314对任何脚本问题概不负责，包括但不限于由任何脚本错误导致的任何损失或损害.**

* 您必须在下载后的**24小时内**从计算机或手机中完全删除以上内容.
